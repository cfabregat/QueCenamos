            ...
            <table align='center' border='1'>
                <tr>
                    <td>
                        ...
                        Ubicación: 
                            <input type="text" name="ubicacion_nombre" placeholder="Nombre" required/>
                            <input type="text" name="ubicacion_direccion" placeholder="Direccion"required/>
                            <input type="text" name="ubicacion_telefono" placeholder="Telefono" required/>
                            <input type="text" name="ubicacion_redsocial" placeholder="Red Social" required/><br />
                        Plato: 
                            <input type="text" name="nombre" value="Nombre" required/>
                            <input type="text" name="descripcion" value="Descripcion" required/>
                            <input type="text" name="precio" value="Precio" required/><br />
                        Foto: <input type="file" name="foto" value="foto"required/><br />
                        Calificaci&oacute;n:
